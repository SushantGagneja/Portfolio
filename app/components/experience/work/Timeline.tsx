    ...
    <group position={point.point} scale={isMobile ? 0.35 : 0.6}>
      ...
      <group>
        <group position={getPoint}>
          <Text {...textProps} fontSize={0.3} position={[-diff / 2, 0, 0]} anchorY="bottom">
            {point.year}
          </Text>
          <group position={[0, -0.1, 0]}>
            <Text {...titleProps} fontSize={0.45} maxWidth={3} position={[0, -diff / 2, 0]} anchorY="top">
              {point.title}
            </Text>
            <Text {...textProps} fontSize={0.25} position={[0, -1.1 - diff, 0]} anchorY="top">
              {point.subtitle}
            </Text>
          </group>
        </group>
